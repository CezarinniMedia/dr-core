...
import { useOfferDomains, useCreateOfferDomain, useDeleteOfferDomain } from "@/hooks/useSpiedOffers";
            ...
            <TableBody>
              {domains.map((d: any) => (
                <TableRow key={d.id}>
                  ...
                  <TableCell>
                    <Badge variant="outline" className={TYPE_BADGE[d.domain_type] || ""}>
                      {d.domain_type}
                    </Badge>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <Button
                      ...
                      onClick={() => deleteMutation.mutate({ id: d.id, offerId })}
                    >
      ...
      <Dialog open={showForm} onOpenChange={setShowForm}>
        <DialogContent className="max-w-md">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSave} disabled={createMutation.isPending || !form.domain.trim()}>
